...
const Timer = overlayable<Props>(MatchTimerFull, MatchTimerOverlay);

type State = {
  timeDiff: number
}

export default class MatchTimer extends React.Component<Props, State> {
