...
import Settings, {defaultSettings, DisplaySettings} from '../settings'
...
export default class SettingsDialog extends React.Component<Props, State> {
  ...
  mouseMoveListener = () => {
    ...
    this.timeout = window.setTimeout(this.hideButton, 1000)
  };
